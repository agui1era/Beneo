<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Maestro.Master" AutoEventWireup="true" CodeBehind="Asignacion.aspx.cs" Inherits="WEB.Asignacion" %>
    ...
    <div class="card card-default">
        ...
        <div class="row">
            <div class="form-group col-md-6 col-sm-6">
                ...
                <asp:DropDownList ID="ddlLugar" runat="server" CssClass="form-control select2 select2-container select2-container--default" DataValueField="Id" DataTextField="Nombre" AutoPostBack="true" OnSelectedIndexChanged="ddlLugar_SelectedIndexChanged"></asp:DropDownList>
            </div>
            <div class="form-group col-md-6 col-sm-6">
