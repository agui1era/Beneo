<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Maestro.Master" AutoEventWireup="true" CodeBehind="CategoriaHerramienta.aspx.cs" Inherits="WEB.CategoriaHerramienta" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     
    <div class="col-sm-6">
        <h1 class="m-0 text-dark">Categoria de Herramientas</h1>
    </div>
    <!-- /.col -->
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="../Inicial/Forma.aspx">Inicio</a></li>
            <li class="breadcrumb-item active">Categoria Herramienta</li>
        </ol>
    </div>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card card-default">
        <div class="card-header">
            <h3 class="card-title">Categoria Herramienta</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <div class="card-body">
            ...
            <div class="row">
                <div class="form-group col-md-6 col-sm-6">
                    ...
                    <asp:TextBox ID="txtCodigo" runat="server" class="form-control" placeholder="Codigo de Categoria" autocomplete="off"></asp:TextBox>
                </div>
                <div class="form-group col-md-6 col-sm-6">
                    <label for="txtCatHerramienta">Categoria</label>
                    <asp:TextBox ID="txtCatHerramienta" runat="server" class="form-control" placeholder="Categoria de herramienta " autocomplete="off"></asp:TextBox>
                </div>
            </div>
    </div>
    <!-- /.card-body -->
