<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Maestro.Master" AutoEventWireup="true" CodeBehind="Lugar.aspx.cs" Inherits="WEB.Lugar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <div class="col-sm-6">
        <h1 class="m-0 text-dark">Lugar</h1>
    </div>
    <!-- /.col -->
    <div class="col-sm-6">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card card-default">
        <div class="card-header">
            <h3 class="card-title">Actualización de Lugar</h3>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Consulta de Lugar</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
            <asp:GridView ID="dtgLugar" CssClass="table table-bordered table-striped dataTable dtr-inline" role="grid" DataKeyNames="ID" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="20" OnPageIndexChanging="dtgLugar_PageIndexChanging" OnRowCommand="dtgLugar_RowCommand" OnDataBound="dtgLugar_DataBound" OnRowCreated="dtgLugar_RowCreated">
                <Columns>
