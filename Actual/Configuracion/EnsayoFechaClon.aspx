<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Maestro.Master" AutoEventWireup="true" CodeBehind="EnsayoFechaClon.aspx.cs" Inherits="WEB.EnsayoFechaClon" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="EnsayoClonar.aspx">Ensayo Clón</a></li>
            <li class="breadcrumb-item active">Fechas de cosecha Clón</li>
        </ol>
    </div>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card card-default">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <asp:GridView ID="dtgEnsayos" CssClass="table table-bordered table-striped dataTable dtr-inline" role="grid" DataKeyNames="ID" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="20" OnRowCommand="dtgEnsayo_RowCommand" OnDataBound="dtgEnsayos_DataBound" OnRowCreated="dtgEnsayos_RowCreated">
                <Columns>
        ...
        <!-- /.card-body -->
            <div class="card-footer">
                <asp:Button ID="btnCancelar" runat="server" Text="Volver" CssClass="btn btn-secondary" OnClick="btnCancelar_Click" />
            </div>
    </div>
</asp:Content>
