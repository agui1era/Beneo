<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Maestro.Master" AutoEventWireup="true" CodeBehind="Tratamiento.aspx.cs" Inherits="WEB.Tratamiento" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <div class="col-sm-6">
        <h1 class="m-0 text-dark">Tratamiento</h1>
    </div>
    <!-- /.col -->
    <div class="col-sm-6">
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="card card-default">
        <div class="card-header">
            <h3 class="card-title">Consulta Tratamiento</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <div class="card-body">
    ...
    <div class="card">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <asp:GridView ID="dtgTratamiento" CssClass="table table-bordered table-striped" DataKeyNames="ID" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="20" OnPageIndexChanging="dtgTratamiento_PageIndexChanging" OnRowCommand="dtgTratamiento_RowCommand">
                <Columns>
