<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Maestro.Master" AutoEventWireup="true" CodeBehind="RegistroActividad.aspx.cs" Inherits="WEB.RegistroActividad" EnableEventValidation="false" %>
...
<%--        function VerFecha() {
            ...
            var dataValue = { "fecha": $("#<%= txtFechaEjecucion.ClientID %>"), "idPrograAct" : $("#<%= hdfIdPrograAct.ClientID %>").val() };

            $.ajax({
                type: "POST",
                url: "RegistroActividad.aspx/OnSubmit",
                data: dataValue,
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    $('label[for="lblPeriodo"]').css('visibility', 'hidden');
                },
                complete: function (result) {
                    ...
                    if (result = "0")
                        ...
                        $('label[for="lblPeriodo"]').css('visibility', 'visible');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="hdfIdPrograAct" runat="server" />
    <div class="card card-default">
        ...
        <div class="row">
            <div class="form-group col-md-6 col-sm-6">
                    ...
                    <asp:DropDownList ID="ddlTemporada" runat="server" CssClass="form-control select2" DataValueField="Id" DataTextField="Nombre" AutoPostBack="True" OnSelectedIndexChanged="ddlTemporada_SelectedIndexChanged"></asp:DropDownList>
        ...
        <div class="modal" id="FinalizarRegistroActividad" tabindex="-1" role="dialog" aria-labelledby="FinalizarRegistroActividadLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 col-sm-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <asp:TextBox ID="txtFechaEjecucion" CssClass="form-control" OnTextChanged="txtFechaEjecucion_TextChanged" runat="server" autocomplete="off" data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask="datemask" im-insert="false" AutoPostBack="True" ></asp:TextBox>
                                    <asp:UpdatePanel ID="udpFechaEjecucion" UpdateMode="Conditional" runat="server">
                                        <Triggers>
                                            <asp:AsyncPostBackTrigger ControlID="txtFechaEjecucion" EventName="TextChanged" />
                                        </Triggers>
                                        <ContentTemplate>
                                        <asp:Label ID="lblPeriodo" runat="server" Text="La fecha ingresada no corresponde al periodo de la temporada" Visible ="false"></asp:Label>
                                            </ContentTemplate>
                                    </asp:UpdatePanel>
                                    <%--<label for="lblPeriodo" style="visibility:hidden" >La fecha ingresada no corresponde al periodo de la temporada</label>--%>
                                </div>
                            </div>               
                        </div>
                ...
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="custom-content-below-externo-tab" data-toggle="pill" href="#custom-content-below-externo" role="tab" aria-controls="custom-content-below-externo" aria-selected="false">Externo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-content-below-todos-tab" data-toggle="pill" href="#custom-content-below-todos" role="tab" aria-controls="custom-content-below-todos" aria-selected="false">Todos los Productos</a>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="custom-content-bellow-tabContent">
                    <div class="tab-pane fade active show" id="custom-content-below-home" role="tabpanel" aria-labelledby="custom-content-below-home-tab">
                        ...
                        <asp:GridView ID="dtgProductos" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" DataKeyNames="IdProducto,IdBodega,FechaVctoTexto" EmptyDataText="No existen productos"  >
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Vence" HeaderText="FechaVcto" DataFormatString="{0:d}" />
                                    <asp:TemplateField HeaderText="Cantidad">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtCantidad" runat="server" CssClass="form-control" Text='<%#Eval("Cantidad") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Merma">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtMerma" runat="server" CssClass="form-control" Text='<%#Eval("Cantidad") %>'></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                    ...
                    <div class="tab-pane fade" id="custom-content-below-profile" role="tabpanel" aria-labelledby="custom-content-below-externo">
                         <asp:GridView ID="dtgHerramientas" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" DataKeyNames="IdHerramienta,IdBodega" EmptyDataText="No existen herramientas" >
                                <Columns>
                                    <asp:BoundField DataField="Codigo" HeaderText="Código" />
                    ...
                    <div class="tab-pane fade" id="custom-content-below-externo" role="tabpanel" aria-labelledby="custom-content-below-externo-tab">
                         <asp:GridView ID="dtgExterno" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" DataKeyNames="Id" AllowPaging="true" EmptyDataText="No existen productos" >
                                <Columns>
                                    <asp:BoundField DataField="Codigo" HeaderText="Código" />
                                    <asp:BoundField DataField="Descripcion" HeaderText="Producto" />
                                    <asp:TemplateField HeaderText="Cantidad">
                    ...
                    <div class="tab-pane fade" id="custom-content-below-todos" role="tabpanel" aria-labelledby="custom-content-below-todos-tab">
                         <asp:GridView ID="dtgTodos" runat="server" CssClass="table table-bordered table-striped" AutoGenerateColumns="False" DataKeyNames="IdProducto,IdBodega,FechaVctoTexto" AllowPaging="true" EmptyDataText="No existen productos" >
                                <Columns>
                                    <asp:BoundField DataField="Codigo" HeaderText="Código" />
                                    <asp:BoundField DataField="Descripcion" HeaderText="Producto" />
                                    <asp:BoundField DataField="Nombre" HeaderText="Bodega" />
                                    <asp:BoundField DataField="Stock" HeaderText="Stock" DataFormatString="{0:#,##0.##}" />
                                    <asp:BoundField DataField="FechaVcto" HeaderText="FechaVcto" DataFormatString="{0:d}" />
                                    <asp:TemplateField HeaderText="Cantidad">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtCantidad" runat="server" CssClass="form-control" Text='<%#Eval("Cantidad") %>'></asp:TextBox>
                                        </ItemTemplate>
