...
namespace WEB {
  public partial class ProgramacionCons : FrmBase {
    ...
    protected void Page_Load(object sender, EventArgs e) {
      miMaster.MarcarMenu("mniProgramacion", "mniProgra");
      if (!IsPostBack) {
        InicializarFiltros();
    ...
    private void LlenarGrilla() {
      ...
      DataTable dtsTabla = objApp.TraerTabla("ProgramacionSel_Grids", objParam, 60);
